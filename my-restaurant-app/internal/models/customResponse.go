...
func ManageResponseOrders(w http.ResponseWriter, errString string, code int, u []*OrderResponse) {
	response := GenericResponse{
		Message: map[string]string{"message": errString},
		Data:    u,
	}
...
func ManageResponseReserv(w http.ResponseWriter, errString string, code int, u *ReservationResponse) {
	response := GenericResponse{
		Message: map[string]string{"message": errString},
		Data:    u,
	}
...
func ManageResponseReservAll(w http.ResponseWriter, errString string, code int, u []*ReservationResponse) {
	response := GenericResponse{
		Message: map[string]string{"message": errString},
		Data:    u,
	}
